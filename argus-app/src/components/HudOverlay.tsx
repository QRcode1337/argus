...
export function HudOverlay({
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-20 text-[10px] text-[#b8bb26]">
      ...
      {sidebarVisible ? (
        <nav className="pointer-events-auto absolute left-4 top-[8.5rem] hidden max-h-[calc(100vh-11rem)] w-80 overflow-y-auto overflow-x-hidden rounded-2xl border border-[#3c3836] bg-[#1d2021d9] shadow-[0_0_40px_rgba(131,165,152,0.2)] backdrop-blur-md md:block">
